...
import { requestMarketerMagicLink } from '@/lib/actions/marketer-magic-link'
...
function LoginForm() {
  const [state, formAction, pending] = useActionState(requestMarketerMagicLink, null)
            ...
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  If this email is associated with a marketer account, you will receive a login link.
                </p>
              </div>
